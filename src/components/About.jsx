...
import aboutStyles from '../assets/BOOKSELLER/dummystyles'
import { apbranches, apstats, apteamMembers } from '../assets/BOOKSELLER/dummydata'
import AboutUsImage from '../assets/BOOKSELLER/AboutUsImage.png'
          ...
          <div className={aboutStyles.innerContainer}>
            <div className={aboutStyles.headingWrapper}>
              ...
              <p className={aboutStyles.subText}>
                ...
                imagination with innovation through curated literary
                experiences.
              </p>
            </div>
          </div>
