...
import { container, formContainer, headerText, inputField, inputWrapper, paragraphText, searchButton, subHeader } from "../assets/BOOKSELLER/dummystyles";
import { geometricOverlay, glassBox } from '../assets/BOOKSELLER/dummystyles';
import { useNavigate } from 'react-router-dom';
import { words } from '../assets/BOOKSELLER/dummydata';
                          ...
                          <div className={formContainer}>
                              <div className={inputWrapper}>
                                  ...
                                  <div className='relative flex items-center'>
                                      ...
                                      <input type='text' value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} placeholder='Search Author, titles, or concept...' className={inputField}/>
