...
import { footerStyles as styles } from '../assets/BOOKSELLER/dummystyles'
import { Link } from 'react-router-dom'
import logo from "../assets/BOOKSELLER/logoicon.png";
import { socialLinks, quickLinks } from "../assets/BOOKSELLER/dummydata";
    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
          ...
          <div className={styles.contactBlock}>
            ...
            <div className={styles.contactList}>
              <div className={styles.contactItem}>
                ...
                <span>PS_12 Literar Lane, Indus Town, Hoshangabad Road </span>
              </div>
        ...
        <div className={styles.copyrightWrap}>
          ...
          <a href="https://hexagondigitalservices.com/" target='_blank'
