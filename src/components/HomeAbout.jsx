...
import { homeAboutStyles as s } from '../assets/BOOKSELLER/dummystyles'
import HomeAboutImage from '../assets/BOOKSELLER/HomeAboutImage.png'
import { featuredBooks, hastats } from '../assets/BOOKSELLER/dummydata'
      ...
      <div className="absolute inset-0 overflow-hidden">
          ...
          <div className={s.container}>
              <div className={s.aboutGrid}>
                  ...
                  <div className='space-y-8'>
                      ...
                      <p className={s.aboutText}>
                          ...
                          We curate exceptional reading experiences, connecting readers with stories that inspire, educate and transport them to new World!
                      </p>
              ...
              <div className='mb-12 text-center'>
                  ...
                  <p className={s.headerText}>Handpicked recommendations from our literary experts that you won't want to miss.                       
                  </p>
              </div>
