...
import { loginStyles } from "../assets/BOOKSELLER/dummystyles";
...
//               <button type='submit' disabled={isSubmitting} className={loginStyles.submitButton}>{ isSubmitting ? 'Signing in... ' : 'Sign in'}</button>
//             </form>
//             <div className={loginStyles.footerText}>
//               Don't have an account{" "}
//               <Link to='/signup' className={loginStyles.footerLink}>
