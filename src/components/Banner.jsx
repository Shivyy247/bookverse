...
import { container, formContainer, headerText, inputField, inputWrapper, paragraphText, searchButton, statNumber, statBox, statsContainer, subHeader, statLabel, imageSection, imageWrapper, imageStyle, overlayEffect, scrollTextSection, scrollText } from "../assets/BOOKSELLER/dummystyles";
import { geometricOverlay, glassBox } from '../assets/BOOKSELLER/dummystyles.js';
import { useNavigate } from 'react-router-dom';
import { words } from '../assets/BOOKSELLER/dummydata.js';
import { Search } from 'lucide-react';
import img from '../assets/BOOKSELLER/banner1.png'
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div className={statsContainer}>
              {[
                { number: "58k+", label: "Titles" },
                { number: "1.2M", label: "Readers" },
                { number: "248k", label: "Topics" },
              ].map((stat, i) => (
